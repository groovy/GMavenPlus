...
public class GroovydocTestsMojo extends AbstractGroovydocMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        if (groovyVersionSupportsAction()) {
            ...
            try {
                generateGroovydoc(getTestSourceRoots(groovydocJavaSources), testGroovydocOutputDirectory);
            } catch (ClassNotFoundException e) {
                throw new MojoExecutionException("Unable to get a Groovy class from classpath.  Do you have Groovy as a compile dependency in your project?", e);
            } catch (InvocationTargetException e) {
                throw new MojoExecutionException("Error occurred while calling a method on a Groovy class from classpath.", e.getCause() != null ? e.getCause() : e);
